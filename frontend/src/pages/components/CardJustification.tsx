...
class CardJustification extends React.Component<Card> {
				...
				<div className="CardJustification-content">
					...
					<div className="CardJustification-footer">
						<div className="CardJustification-footer-update">
							Last updated: {moment(this.props.updated_at).fromNow()}
						</div>
						<div >
							<a className="CardJustification-footer-button" href={this.props.scryfall_url} target="_blank" rel="noopener noreferrer">
								<button>
									View Card
								</button>
							</a>
